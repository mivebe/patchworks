    ...
    <div className="flex items-center gap-3 px-4 py-2">
      {isPlacingSpecialPatch ? (
        <div className="text-yellow-300 font-medium">
          Click an empty cell to place your special 1x1 patch
        </div>
      ) : (
        <>
          <button
            ...
            className="px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 disabled:bg-gray-700 disabled:text-gray-500 text-white font-medium transition-colors"
          >
          ...
          {hasPatchSelected && (
            <>
              ...
              <button
                ...
                className="px-3 py-2 rounded-lg bg-gray-700 hover:bg-red-700 text-gray-300 transition-colors"
              >
                Cancel
              </button>
              <span className="text-gray-400 text-sm">Click on quilt to place</span>
            </>
          )}
        </>
      )}
